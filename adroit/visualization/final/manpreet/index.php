...
<ul>  
    ...
    <li style="float:right; padding: 20px; padding-right: 40px;"><a href="../../manpreet folder/html/introduction.php">
      <i class ="fa fa-user-plus" ></i> << Back</a></li>
      
</ul>
<br> <br> <br> 
<h1 style="font-size: 40px; color: #003B78;" align="center">Binary Search Tree Visualization and AVL </h1>
<p style="font-family: Times New Roman; font-size: 25px; padding-left: 40px;">Instructions : <br>
