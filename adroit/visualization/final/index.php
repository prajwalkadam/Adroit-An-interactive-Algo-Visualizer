...
<ul>  
    ...
    <li style="float:right; padding: 20px; padding-right: 40px;"><a href="index.html"><i class ="fa fa-user-plus" ></i> << Back</a></li>
...
<div class="webinar-grid"  >
  ...
  <a href="/learning/webinars/18-12-2016-visualizing-r-advanced-analytics-results-in-dundas-bi" class="link-block" >
    <div class="jumbotron left-right-jumbotron-block" style="height:550px;background-color:darkblue;">
     ...
     <li>Selection Sort</li></ol>
      ...
      <div class="webinar-content-box" style="font-size: 20px;">
        ...
        <span class="dundas-blue-link">Visualization &gt;</span>
      </div>
    </div>
  </a>
