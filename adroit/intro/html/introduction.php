  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarToggler">
      <ul class="navbar-nav ml-lg-5 mt-3 mt-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link" href="#concept">CONCEPT THEORY</a>
        </li>
        <li class="nav-item">
    ...
    <div class="container h-100">
      <div class="row align-items-center h-100">
        <div class="col-lg-6 wow fadeInUp">
          <div class="badge mb-2"><span class="icon mr-1"><span class="mai-globe"></span></span> An intuitive idea for learners </div>
...
<div class="page-section" id= "concept">
  <div class="container">
    <div class="row">
...
<div class="page-section bg-image" style="background-image: url(../assets/img/Flat-Mountains.svg);" id="scoreboard">
  <div class="container">
    <div class="row justify-content-center align-items-center">
      <div class="col-lg-5 mb-5 mb-lg-0 wow fadeInUp">
        <h1 class="mb-4">ScoreBoard</h1>
        <p class="mb-5">Click Here!</p>
...
<div class="page-footer-section bg-dark fg-white" style="height:50px;">
  <div class="container" style="margin-left: 590px;margin-top: -59px;">
